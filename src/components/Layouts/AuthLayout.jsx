    ...
    <>
      <main className="min-h-screen bg-special-mainBg flex justify-center items-center">
        ...
        <div className="max-w-md w-full p-6">
          ...
          {/* sign in/up with google start */}
          <div className="mb-8">
            <button 
              type="button" 
              className="h-12 rounded-md text-sm w-full bg-gray-05 text-gray-02 flex justify-center items-center font-semibold cursor-pointer border border-gray-200"
            >
              <svg
          ...
          <div className="flex justify-center gap-1 text-sm mt-4">
            ...
            >
              {type === 'signin' ? 'Create an account' : 'Sign in here'}
            </Link>
          </div>
          {/* link end */}
        </div>
